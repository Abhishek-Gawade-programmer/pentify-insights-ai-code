...
semantic_model = {
    "tables": [
        ...
        {
            "table_name": "quotes",
            "table_description": "Captures financial and status details for quotes, including pricing, discounts,revenue, associated projects, and company details.",
            "Use Case": "Use this table to manage and analyze quotes issued to companies and projects, track financial details also  revenue, and monitor quote status.",
        },
    ]
}
...
async def get_sql_agent(
    ...
    async with MCPTools(server_params=server_params) as mcp_tools:
        ...
        agent = Agent(
            ...
            - HubSpot data integration and analysis

            You combine deep business knowledge with advanced SQL expertise to uncover insights from company, contact, project, quote data and HubSpot integration."""
            ),
            instructions=dedent(
                f"""\
